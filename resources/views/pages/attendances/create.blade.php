...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tạo điểm danh</li>
        </ol>
    </nav>
    <div class="form-content shadow">
        <h6 class="font-weight-bold text-primary">Tạo điểm danh</h6>
        <form class="needs-validation form-main" novalidate method="POST" action="{{ route('attendances.create') }}">
            {{ csrf_field() }}
            <div class="form-group">
                <label class="required" for="fullname">Có mặt</label>
                <input name="attendance" type="text" class="form-control" id="fullname" placeholder="ví dụ: D, N, M, P"
                    required>
