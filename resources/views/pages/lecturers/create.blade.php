...
@section('content')
    ...
    <div class="form-content shadow">
        <h6 class="font-weight-bold text-primary">Thêm giảng viên</h6>
        @if ($errors->any())
        ...
        @endif
        <form class="needs-validation form-main" novalidate method="POST" action="{{ route('lecturers.create') }}"
            oninput='password_r.setCustomValidity(password_r.value != password.value ? "Mật
            khẩu không khớp" : "" )'>
            {{ csrf_field() }}
            <div class="form-group">
                <label class="required" for="fullname">Họ và tên</label>
                <input name="full_name" type="text" class="form-control" id="fullname" placeholder="Nhập họ và tên"
                    required>
            ...
            <div class="form-group">
                ...
                <input name="email" type="text" class="form-control" id="email" placeholder="Nhập email" required>
                <div class="ml-2 invalid-feedback">
                    Vui lòng nhập email!
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input name="dob" type="date" class="form-control" id="phone" placeholder="Nhập số điện thoại"
                    required>
                <div class="ml-2 invalid-feedback">
